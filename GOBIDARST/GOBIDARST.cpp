...
int main() 
{
    ...
    salas[15] = criarSala("Voce anda pelo vasto corredor até chegar em uma parte que possui espelhos em ambos as paredes.\nTal disposição de espelhos reflete a sua imagem infinitas vezes, o que te deixa desconfortavel.\nVoce pode seguir para o LESTE ou para OESTE.", 0);
    ...
    salas[45] = criarSala("Ao entrar na galeria, o ar frio e estagnado te envolve, um sussurro de misterios antigos.\nAs pinturas que adornam as paredes sao homenagens macabras à entidade que uma vez governou este lugar. \nCada tela eh um portal para uma visão perturbadora, onde anjos caidos veneram a criatura disfarcada, suas asas quebradas formando um coro sombrio ao redor do falso sacerdote.\nNo centro da sala consegue se ver uma chave em formato de um anjo Principado, a qual voce coleta.", 1);
